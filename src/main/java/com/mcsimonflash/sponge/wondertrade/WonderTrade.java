...
@Plugin(id = WonderTrade.PluginID, name = "WonderTradePlus", version = "1.1.15", description = "Lets you do spicy thing with ur beloved pokémon.", dependencies = @Dependency(id = "pixelmon", version = "8.0.0"), authors = {
