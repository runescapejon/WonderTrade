...
@Plugin(id = "wondertrade", name = "WonderTrade", version = "1.1.3", description = "Lets you do spicy thing with ur beloved pokémon.", dependencies = @Dependency(id = "pixelmon", version = "7.0.0"), authors = {"Simon_Flash", "happyzleaf"})
